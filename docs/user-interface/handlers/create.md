...
> [!IMPORTANT]
> The Windows App SDK v1.2 includes a control to play video. However, .NET MAUI currently uses an earlier of the Windows App SDK. The Windows App SDK v1.2 must be added to your .NET MAUI app project, with the NuGet package manager, if you want to play video on Windows.
