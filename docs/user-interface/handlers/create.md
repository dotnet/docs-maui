...
:::image type="content" source="media/create/play-video.png.png" alt-text="Screenshot of video playback on iOS.":::
:::image type="content" source="media/create/play-video.png.png" alt-text="Screenshot of video playback using custom transport controls on iOS.":::
...
1. Create `partial` handler classes for each platform, that create the native views that implement the cross-platform control. For more information, see [Create platform controls](create-platform-controls.md).
