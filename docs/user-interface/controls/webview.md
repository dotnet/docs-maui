...
01. Add the following class to the _Platforms/Android_ folder, changing the root namespace to match your project's namespace, but without .Platforms.Android part:
