...
| `Image` | `Image` displays an image that can be loaded from a local file, an embedded resource, a URI, or a stream. For more information, see [Image](~/user-interface/controls/image.md). |
