...
| `IndicatorView` | `IndicatorView` displays indicators that represent the number of items in a <xref:Microsoft.Maui.Controls.CarouselView>. For more information, see [IndicatorView](~/user-interface/controls/indicatorview.md). |
