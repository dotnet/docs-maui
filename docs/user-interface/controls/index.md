...
| View | Description |
| --- | --- |
| `BlazorWebView` | `BlazorWebView` allows you to host a Blazor web app in your .NET MAUI app. For more information, see [BlazorWebView](~/user-interface/controls/blazorwebview.md). |
