...
These properties are backed by `BindableProperty` objects, which means that the properties can be targets of data bindings and styled. For more information about attached properties, see [.NET MAUI Attached Properties](~/fundamentals/attached-properties.md).
