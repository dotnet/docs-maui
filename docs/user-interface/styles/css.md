...
|`-maui-shadow`|<xref:Microsoft.Maui.Controls.VisualElement>|`color, offsetX, offsetY` \| `offset X, offsetY, radius, color` \| `offset X, offsetY, radius, color, opactity` | `-maui-shadow: #000000 4 4;` |
