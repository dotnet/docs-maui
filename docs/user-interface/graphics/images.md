...
The .NET Multi-platform App UI (.NET MAUI) graphics library includes functionality to load, save, resize, and downsize images. Supported image formats are dependent on the underlying platform.
