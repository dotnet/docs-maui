...
- <xref:Microsoft.Maui.Graphics> transforms are applied to the `ICanvas` object, while <xref:Microsoft.Maui.Controls.VisualElement> transforms are applied to a <xref:Microsoft.Maui.Controls.VisualElement> derived object.
- <xref:Microsoft.Maui.Graphics> transforms are relative to the upper-left corner of the `ICanvas`, while <xref:Microsoft.Maui.Controls.VisualElement> transforms are relative to the upper-left corner of the <xref:Microsoft.Maui.Controls.VisualElement> to which they're applied.
