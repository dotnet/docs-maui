...
description: ".NET MAUI graphics includes a LinearGradientPaint class, that paints a graphical object with a linear gradient."
ms.date: 07/15/2021
---
