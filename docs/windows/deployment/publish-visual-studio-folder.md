...
:::image type="content" source="media/publish-visual-studio/vs-debugtarget-net10.png" alt-text="Selecting the Windows debug target for a .NET MAUI app in Visual Studio.":::
