...
>
> If you would prefer not to install Visual Studio for 2022 Mac, Visual Studio 2022 can automatically configure the Mac build host. However, you must still install and run Xcode.
