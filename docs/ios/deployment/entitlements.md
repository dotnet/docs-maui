...
| ----------- | ----------- | --- | ---- | ------- |
| Access WiFi information | This entitlement enables your app to obtain information about the currently connected WiFi network. | `com.apple.developer.networking.wifi-info` | Boolean | `<key>com.apple.developer.networking.wifi-info</key>`<br/>`<true/>` |
