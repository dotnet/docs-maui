...
| Entitlement | Description | Keys | Type | Example |
| ----------- | ----------- | ---- | ---- | ------- |
| Access WiFi information | This entitlement enables your app to obtain information about the currently connected Wi-Fi network. |   |   |   |
