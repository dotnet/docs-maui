...
:::image type="content" source="what-is-maui-images/maui.png" alt-text=".NET MAUI supported platforms.":::
...
:::image type="content" source="what-is-maui-images/architecture.png" alt-text=".NET MAUI architecture diagram.":::
