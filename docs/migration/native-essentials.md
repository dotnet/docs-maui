---
title: "Migrate Xamarin.Essentials code in .NET Android and .NET for iOS apps"
description: "Learn how to migrate your Xamarin.Essentials code in .NET for iOS and .NET Android apps."
ms.date: 03/09/2023
no-loc: [ "Xamarin.Essentials", ".NET MAUI" ]
---

# Migrate Xamarin.Essentials code in .NET Android and .NET for iOS apps
...
The following steps outline the process to use .NET MAUI's native device functionality, formerly known as Xamarin.Essentials, in a .NET Android or .NET for iOS app:

1. Remove the Xamarin.Essentials NuGet package from your .NET Android or .NET for iOS app.
...
To use .NET MAUIs native device functionality in a .NET Android or .NET for iOS app, modify your project file and set the `$(UseMauiEssentials)` build property to `true`.
