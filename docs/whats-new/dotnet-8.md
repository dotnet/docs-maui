...
- The `Application.Properties` property and `Application.SavePropertiesAsync` method. To migrate your app properties data to .NET MAUI, see [Migrate data from the Xamarin.Forms app properties dictionary to .NET MAUI preferences](../app-properties.md).
