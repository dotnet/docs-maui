...
For more information, see [Play video fullscreen](~/user-interface/controls/webview.md#play-video-full-screen-on-android?view=net-maui-10.0&preserve-view=true).
