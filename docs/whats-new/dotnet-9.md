...
Trimming behavior can be controlled with the `$(PublishTrimmed)` and `$(TrimMode)` MSBuild properties. For more information, see [Trim a .NET MAUI Android app](~/android/trimmind.md).
