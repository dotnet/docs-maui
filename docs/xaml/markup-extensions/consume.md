...
- [`TemplateBinding`](xref:Microsoft.Maui.Controls.TemplateBindingExtension) - performs data binding from a control template. For more information, see [Control templates](~/fundamentals/controltemplate.md).
