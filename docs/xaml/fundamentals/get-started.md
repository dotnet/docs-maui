...
The `MainPage` class derives from <xref:Microsoft.Maui.Controls.ContentPage>, and is a [Partial Class](https://learn.microsoft.com/dotnet/csharp/programming-guide/classes-and-structs/partial-classes-and-methods) definition.
